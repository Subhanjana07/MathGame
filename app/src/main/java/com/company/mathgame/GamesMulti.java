...
public class GamesMulti extends AppCompatActivity {
    TextView score;
    TextView life;
    TextView time;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(GamesMulti.this, "Please enter an answer", Toast.LENGTH_SHORT).show();
                } else if (!TextUtils.isDigitsOnly(answer.getText().toString())) {

                    Toast.makeText(GamesMulti.this, "you can only enter numbers", Toast.LENGTH_SHORT).show();
        ...
        nextQues.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userLife <= 0 )
                {
                    Toast.makeText(GamesMulti.this, "Game Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(GamesMulti.this, Result.class);
